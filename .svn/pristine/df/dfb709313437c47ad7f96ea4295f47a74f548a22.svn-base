...
<html>
    <head>
        ...
        <script src="<%=request.getContextPath()%>/resources/jss/cadastroUsuarios.js"></script>
    ...
    <body>
        ...
        <div class="container conteudo">
            ...
            <form:form action="salvarUsuario" id="salvarUsuario" commandName="Usuario" method="POST">
                ...
                <div class="row col-md-offset-2">
                    ...
                    <div class="form-group col-md-5">
                        ...
                        <form:input minlength="14" id="cpf" type="text" path="cpf" cssClass="form-control" required="required"/> 
                    </div>
                ...
                <!-- Button -->
                    ...
                    <div class="col-md-offset-4 col-md-4 form-group row">
                        <button  class="col-md-offset-2 btn btn-primary col-md-4" >Gravar</button>
                        <button  class="btn btn-primary col-md-4 " type="reset">Limpar</button>
